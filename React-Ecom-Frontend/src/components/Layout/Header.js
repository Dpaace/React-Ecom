        ...
        <NavLink className="navbar-brand" to="/">
          <div className="d-flex align-items-center">
            ...
            <h3 className="text-dark fw-bold">
              <span className="text-danger fw-bold">React</span>
              <span className="me-1">-Ecom</span>
            </h3>
          </div>
        </NavLink>
          ...
          {token !== null ? (
            <>
              <button
                ...
                className="btn btn-danger ms-2 fw-bold fs-5"
                type="button"
              >
                Logout
              </button>
              ...
              <a href="#" className="btn text-dark">
                ...
                <span className="fw-bold text-uppercase d-none d-md-inline">
                  {username}
                </span>
              </a>
            </>
            ...
            <>
              ...
              <NavLink
                to="/register"
                className="btn btn-outline-success ms-2 fw-bold fs-5"
                type="button"
              >
                Sign Up
              </NavLink>
